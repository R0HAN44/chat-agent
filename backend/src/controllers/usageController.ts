...
export const getUsageSummary = async (req: CustomRequest, res: Response) : Promise<any> => {
  try {
...
export const getUsageHistory = async (req: CustomRequest, res: Response) : Promise<any>=> {
  try {
    const userId = req?.user?.id;
